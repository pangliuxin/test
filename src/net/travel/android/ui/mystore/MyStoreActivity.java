...
import net.travel.android.adapter.SubmenuListViewAdapter;
import net.travel.android.ui.type.MeetBookListViewActivity2;
import net.travel.android.ui.type.MeetBorrowListViewActivity2;
import net.travel.android.ui.type.MeetRoomListViewActivity2;
		...
		mystoreListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				case R.drawable.mystore_collect:
					...
					intent = new Intent(MyStoreActivity.this,
							MeetBookListViewActivity2.class);
					break;

				
				   case R.drawable.mystore_address: if(myApp.getLoginKey()
				  ==null || myApp.getLoginKey().equals("") ||
				   ...
				   = new Intent(MyStoreActivity.this,MeetBorrowListViewActivity2.class);
				   break;
				...
				case R.drawable.mystore_history:
					...
					intent = new Intent(MyStoreActivity.this,
							MeetRoomListViewActivity2.class);
					break;
				/*
	...
	protected void onResume() {
		...
		if (myApp.getRole().equals("管理员")) {
			...
			map3.put(SubmenuListViewAdapter.TAG_ITEM_ICON,
					Integer.valueOf(R.drawable.mystore_collect));
			datas.add(map3);
			...
			map5.put(SubmenuListViewAdapter.TAG_ITEM_ICON,
					Integer.valueOf(R.drawable.mystore_history));
			datas.add(map5);
		}
