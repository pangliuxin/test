 ...
 */
public class RoomBookActivity extends Activity implements View.OnTouchListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.health_add_view);
		myApp = (MyApp) RoomBookActivity.this.getApplication();
		...
		buttonSend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if(EndTime.equals("") || EndTime==null){
					Toast.makeText(RoomBookActivity.this, "不能为空", Toast.LENGTH_SHORT).show();;
					return ;
				}
...
//            			editStarttime.requestFocus(); 
	...
	public void SendData(String end, String start) {
		String url = HttpUtil.URL_MEETBOOKADD;
		String query = "";
		...
		try {
			...
			query += "meetbook.userid=" + myApp.getLoginKey() + "&";
			query += "meetbook.roomid=" + room_id + "&";
			query += "meetbook.starttimestr=" + start + "&";
			query += "meetbook.endtimestr=" + end ;
		...
		try {
			...
			if (response.getStatusLine().getStatusCode() == 200) {
				...
				try {
					...
					if (arrlist != "" && !arrlist.equals("arrlist")
						...
						if (arrlist.equals("1")) {
							Toast.makeText(RoomBookActivity.this, "恭喜，添加成功",
									Toast.LENGTH_SHORT).show();
							;
							
							Intent intent = new Intent(RoomBookActivity.this,MainActivity.class);
							startActivity(intent);
						} else if (arrlist.equals("0")) {
							Toast.makeText(RoomBookActivity.this, "抱歉，添加失败",
									Toast.LENGTH_SHORT).show();
							;
						} else if (arrlist.equals("2")) {
							Toast.makeText(RoomBookActivity.this, "抱歉这个时间段，已被预订",
			...
			e.printStackTrace();
			result = "网络异常！";
			Toast.makeText(RoomBookActivity.this, result, Toast.LENGTH_SHORT)
					.show();
			;
		} catch (IOException e) {
			e.printStackTrace();
