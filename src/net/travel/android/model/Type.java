...
public class Type {
		...
		public Type(String gc_id, String gc_name, String image, String text) {
			super();
			this.gc_id = gc_id;
		...
		public static ArrayList<Type> newInstanceList(String jsonDatas){
			...
			try {
				...
				for(int i = 0; i < size; i++){
					...
					Type t=new Type(gc_id, gc_name, image, text);
					typeList.add(t);
				}
